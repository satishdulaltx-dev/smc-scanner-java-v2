...
public class VolumeProfileCalculator {
    ...
    /**
     * Same algorithm as {@link #calculate} but also returns the raw bucket array,
     * price base, and bucket size so callers can perform HVN/LVN analysis.
     */
    public VolumeProfileDetailed calculateDetailed(List<OHLCV> bars) {
        if (bars == null || bars.size() < 10) return null;
        ...
        return new VolumeProfileDetailed(vpoc, vah, val, vol, lo, bucketSz);
    }
